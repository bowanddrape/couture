    ...
    return (
      <div>
        <div className="items"><div className="product_wrapper">
          <Item fulfillment={true} content_index={this.state.content_index} garment_id={`office-${this.state.shipment.fulfillment_id}-${this.state.content_index}`} {...this.state.shipment.contents[this.state.content_index-1]}/>
        </div></div>
        {actions}
      </div>
    );
